...
#include "HelperIOContainer.h"
#include "Constructive.h"
#include "LocalSearch.h"
#include "SPHeuristic.h"
#include "HelperIO.h"
#include "SerializationVRP.h"
#include "Instance.h"
#include "Solution.h"

#include "LoadingInterfaceServices.h"
#include "SubtourCallback.h"
#include "VehicleRoutingModels.h"
...
std::vector<Route> BranchAndCutSolver::SetGivenStartSolution()
{
    ...
    bool isRegularFile = true;//std::filesystem::is_regular_file(startSolutionFilePath);
    if (!isRegularFile)
    {
